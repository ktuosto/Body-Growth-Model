...
#Filter by sex and age class
Filter for means, min, and max 
```{r}

# Filter the data frame by sex and age groups
female_AD <- subset(tibia, sex == "F" & class == "AD")
female_SAD <- subset(tibia, sex == "F" & class == "S-AD")
female_JUV <- subset(tibia, sex == "F" & class == "JUV")
female_INF <- subset(tibia, sex == "F" & class == "INF")
male_AD <- subset(tibia, sex == "M" & class == "AD")
male_SAD <- subset(tibia, sex == "M" & class == "S-AD")
male_JUV <- subset(tibia, sex == "M" & class == "JUV")
male_INF <- subset(tibia, sex == "M" & class == "INF")

# Define the mean_max_min function
mean_max_min <- function(df) {
  mean_vals <- mean(df$DIL)
  max_vals <- max(df$DIL)
  min_vals <- min(df$DIL)
